...
X_train.to_csv("train/X_train_processed.csv")
X_test.to_csv("test/X_test_processed.csv")
y_train.to_csv("train/y_train_enc.csv")
y_test.to_csv("test/y_test_enc.csv")
